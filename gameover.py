...
class MyGame(arcade.Window):
    ...
    def __init__(self, screen_width, screen_height):
        ...
        # each level.
        self.instructions = []
        texture = arcade.load_texture("Shield.png")
        self.instructions.append(texture)

        texture = arcade.load_texture("Lazer.png")
        self.instructions.append(texture)
    ...
    def setup(self):
        ...
        # Set up the player
        self.score = 0
        self.player_sprite = arcade.Sprite("Defender.png", SPRITE_SCALING)
        ...
        for i in range(50):
            ...
            coin = arcade.Sprite("Invader.png", SPRITE_SCALING / 3)
