...
class MyGame(arcade.Window):
    ...
    def update(self, delta_time):
        ...
        elif (self.iteration == 22
            or self.iteration == 24
            or self.iteration == 26
            or self.iteration == 28
            or self.iteration == 30
            or self.iteration == 32
            or self.iteration == 34
            or self.iteration == 36
            or self.iteration == 38
            or self.iteration == 40
            or self.iteration == 42
            or self.iteration == 44
            or self.iteration == 46
            or self.iteration == 48
            or self.iteration == 50
            or self.iteration == 52
            or self.iteration == 54
            or self.iteration == 56
            or self.iteration == 58
        ...
        elif (self.iteration == 62
            or self.iteration == 64
            or self.iteration == 66
            or self.iteration == 68
            or self.iteration == 70
            or self.iteration == 72
            or self.iteration == 74
            or self.iteration == 76
            or self.iteration == 78
